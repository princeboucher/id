...
SELECT * FROM person;
</pre></div><div class="section" id="scroll-annotation"><div class="titlepage"><div><div><h3 class="title">13.4.&nbsp;Scrolling the result</h3></div></div></div><p>
...
SELECT *
FROM activity_log;
</pre></div><div class="section" id="append-annotation"><div class="titlepage"><div><div><h3 class="title">13.5.&nbsp;Appending a results</h3></div></div></div><p>
