<html><head><META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><title>29.&nbsp;Common DBMS problems</title><link href="html-publish.css" type="text/css" rel="stylesheet"><meta content="DocBook XSL Stylesheets V1.79.0" name="generator"><link rel="home" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="up" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="prev" href="troubleshooting.html" title="28.&nbsp;Common problems"><link rel="next" href="options.html" title="30.&nbsp;Options dialog"><link rel="article" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="subsection" href="dbms-problems.html#oracle-problems" title="29.1.&nbsp;Oracle"><link rel="subsection" href="dbms-problems.html#mysql-problems" title="29.2.&nbsp;MySQL"><link rel="subsection" href="dbms-problems.html#mssql-problems" title="29.3.&nbsp;Microsoft SQL Server"><link rel="subsection" href="dbms-problems.html#db2-problems" title="29.4.&nbsp;IBM DB2"><link rel="subsection" href="dbms-problems.html#pg-problems" title="29.5.&nbsp;PostgreSQL"><link rel="subsection" href="dbms-problems.html#sqlanywhere-problems" title="29.6.&nbsp;Sybase SQL Anywhere"></head><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table summary="Navigation header" width="100%"><tr><th align="center" colspan="3">29.&nbsp;Common DBMS problems</th></tr><tr><td align="left" width="20%"><a accesskey="p" href="troubleshooting.html">Prev</a>&nbsp;</td><th align="center" width="60%">&nbsp;</th><td align="right" width="20%">&nbsp;<a accesskey="n" href="options.html">Next</a></td></tr></table><hr></div><div class="section" id="dbms-problems"><div class="titlepage"><div><div><h2 class="title" style="clear: both">29.&nbsp;Common DBMS problems</h2></div></div></div><div class="toc"><dl class="toc"><dt><span class="section"><a href="dbms-problems.html#oracle-problems">29.1. Oracle</a></span></dt><dt><span class="section"><a href="dbms-problems.html#mysql-problems">29.2. MySQL</a></span></dt><dt><span class="section"><a href="dbms-problems.html#mssql-problems">29.3. Microsoft SQL Server</a></span></dt><dt><span class="section"><a href="dbms-problems.html#db2-problems">29.4. IBM DB2</a></span></dt><dt><span class="section"><a href="dbms-problems.html#pg-problems">29.5. PostgreSQL</a></span></dt><dt><span class="section"><a href="dbms-problems.html#sqlanywhere-problems">29.6. Sybase SQL Anywhere</a></span></dt></dl></div><div class="section" id="oracle-problems"><div class="titlepage"><div><div><h3 class="title">29.1.&nbsp;Oracle</h3></div></div></div><a name="N15D2E" class="indexterm"></a><a name="N15D34" class="indexterm"></a><div class="section" id="oracle-db-exp-tables"><div class="titlepage"><div><div><h4 class="title">29.1.1.&nbsp;No Views or tables visible in the DbExplorer</h4></div></div></div><a name="N15D3E" class="indexterm"></a><a name="N15D44" class="indexterm"></a><p>
        ...
        This bug was fixed in the 11.2 drivers.
      </p></div><div class="section" id="oracle-long-problems"><div class="titlepage"><div><div><h4 class="title">29.1.2.&nbsp;Error: "Stream has already been closed"</h4></div></div></div><p>
				...
				has to be switched off using the <a class="link" href="wb-commands.html#command-dbms-output" title="24.40.&nbsp;Using Oracle's DBMS_OUTPUT package">DISABLEOUT</a> command
			...
			</p></div><div class="section" id="oracle-blob-problems"><div class="titlepage"><div><div><h4 class="title">29.1.3.&nbsp;BLOB support is not working properly</h4></div></div></div><p>
				...
				syntax or the <a class="link" href="data-pumper.html" title="25.&nbsp;DataPumper">DataPumper</a>)
			...
			</p></div><div class="section" id="oracle-enable-remarks"><div class="titlepage"><div><div><h4 class="title">29.1.4.&nbsp;Table and column comments are not displayed</h4></div></div></div><a name="N15DC7" class="indexterm"></a><p>
				...
				When you have comments defined in your Oracle database and use the <a class="link" href="wb-commands.html#command-schema-report" title="24.1.&nbsp;Create a report of the database objects - WbSchemaReport">WbSchemaReport</a>
				command, then you have to enable the remarks reporting, otherwise the comments will not show up in the report.
			</p></div><div class="section" id="oracle-date-time"><div class="titlepage"><div><div><h4 class="title">29.1.5.&nbsp;Time for DATE columns is not displayed</h4></div></div></div><p>
      ...
      </p></div><div class="section" id="oracle-display-xml"><div class="titlepage"><div><div><h4 class="title">29.1.6.&nbsp;Content of XMLTYPE columns is not displayed</h4></div></div></div><p>
        ...
        CLOB. Please refer to the chapter <a class="link" href="dbexplorer.html#customize-dbexplorer-retrieval" title="26.6.&nbsp;Customize data retrieval">Customize data retrieval in the DbExplorer</a>
        for details.
      </p><p>
        Note
      </p></div><div class="section" id="oracle-comment-problems"><div class="titlepage"><div><div><h4 class="title">29.1.7.&nbsp;Error: "missing mandatory parameter"</h4></div></div></div><p>
...
SELECT 42 FROM dual;</pre><p>
        ...
        only fix this problems, but are in general much better than the old versions.
      </p></div></div><div class="section" id="mysql-problems"><div class="titlepage"><div><div><h3 class="title">29.2.&nbsp;MySQL</h3></div></div></div><a name="N15E36" class="indexterm"></a><a name="N15E3C" class="indexterm"></a><div class="section" id="mysql-no-info-schema"><div class="titlepage"><div><div><h4 class="title">29.2.1.&nbsp;INFORMATION_SCHEMA tables not displayed in DbExplorer</h4></div></div></div><p>
			...
			</p></div><div class="section" id="mysql-select-problems"><div class="titlepage"><div><div><h4 class="title">29.2.2.&nbsp;"Operation not allowed" error message</h4></div></div></div><p>
			...
			</p></div><div class="section" id="mysql-zero-date-problems"><div class="titlepage"><div><div><h4 class="title">29.2.3.&nbsp;Problems with zero dates with MySQL</h4></div></div></div><p>
        ...
        To ignore errors
      </p></div><div class="section" id="mysql-no-view-source"><div class="titlepage"><div><div><h4 class="title">29.2.4.&nbsp;The SQL source for views is not displayed</h4></div></div></div><p>
      ...
      </p></div><div class="section" id="mysql-no-table-comment"><div class="titlepage"><div><div><h4 class="title">29.2.5.&nbsp;No table comments are displayed in the DbExplorer</h4></div></div></div><a name="N15E99" class="indexterm"></a><p>
      ...
      </p></div></div><div class="section" id="mssql-problems"><div class="titlepage"><div><div><h3 class="title">29.3.&nbsp;Microsoft SQL Server</h3></div></div></div><a name="N15EB2" class="indexterm"></a><a name="N15EB8" class="indexterm"></a><div class="section" id="mssql-wrong-date-value"><div class="titlepage"><div><div><h4 class="title">29.3.1.&nbsp;The value of DATE columns is not correct</h4></div></div></div><a name="N15EC2" class="indexterm"></a><p>
        ...
        and are using version 3.0, please upgrade your driver.
		  </p></div><div class="section" id="mssql-remarks-nodisplay"><div class="titlepage"><div><div><h4 class="title">29.3.2.&nbsp;Column and table comments are not displayed</h4></div></div></div><p>
        ...
        For details, see the section <a class="link" href="settings.html#dbexplorer-ms-remarks" title="Retrieving remarks for Microsoft SQL Server">Retrieving remarks for Microsoft SQL Server</a>.
		  </p></div><div class="section" id="mssql-nt-authentication"><div class="titlepage"><div><div><h4 class="title">29.3.3.&nbsp;Using Windows authentication to connect to a SQL Server</h4></div></div></div><a name="N15EEC" class="indexterm"></a><p>
        ...
        the 32bit DLL. For a 64bit Java Runtime you need to use the 64bit DLL (the architecture of the server is not relevant).
		  </p></div><div class="section" id="mssql-showplan-exception"><div class="titlepage"><div><div><h4 class="title">29.3.4.&nbsp;The Microsoft Driver throws an Exception when using SET SHOWPLAN_ALL</h4></div></div></div><a name="N15F0A" class="indexterm"></a><p>
        ...
        having the result limited.
      </p></div><div class="section" id="mssql-locking-problems"><div class="titlepage"><div><div><h4 class="title">29.3.5.&nbsp;Dealing with locking problems</h4></div></div></div><a name="N15F1E" class="indexterm"></a><p>
				...
				the jTDS driver, you can define a <a class="link" href="profiles.html#profile-connect-scripts" title="7.6.20.&nbsp;Connect scripts">post-connect script</a> that
				runs <code class="literal">SET LOCK_TIMEOUT 0</code>.
			</p></div><div class="section" id="mssql-cloned-connection"><div class="titlepage"><div><div><h4 class="title">29.3.6.&nbsp;Can't start a cloned connection while in manual transaction mode</h4></div></div></div><p>
        ...
        <a class="ulink" href="http://msdn2.microsoft.com/en-us/library/ms378988.aspx" target="_blank">http://msdn2.microsoft.com/en-us/library/ms378988.aspx</a>
		  </p></div><div class="section" id="mssql-result-buffer"><div class="titlepage"><div><div><h4 class="title">29.3.7.&nbsp;WbExport or WbCopy using a lot of memory</h4></div></div></div><a name="N15F60" class="indexterm"></a><a name="N15F66" class="indexterm"></a><p>
        ...
        <a class="ulink" href="http://msdn2.microsoft.com/en-us/library/ms378988.aspx" target="_blank">http://msdn2.microsoft.com/en-us/library/ms378988.aspx</a>
      </p></div><div class="section" id="mssql-sequence-increment"><div class="titlepage"><div><div><h4 class="title">29.3.8.&nbsp;Sequences are incremented twice</h4></div></div></div><a name="N15F9A" class="indexterm"></a><a name="N15FA0" class="indexterm"></a><p>
        ...
        from the JDBC URL. The sequences will then be incremented correctly.
		  </p></div></div><div class="section" id="db2-problems"><div class="titlepage"><div><div><h3 class="title">29.4.&nbsp;IBM DB2</h3></div></div></div><a name="N15FB8" class="indexterm"></a><a name="N15FBE" class="indexterm"></a><div class="section" id="db2-date-before"><div class="titlepage"><div><div><h4 class="title">29.4.1.&nbsp;Dates before 1940-01-01 are not displayed</h4></div></div></div><p>
        ...
        See IBM's FAQ for details: <a class="ulink" href="http://www-03.ibm.com/systems/i/software/toolbox/faqjdbc.html#faqB5" target="_blank">http://www-03.ibm.com/systems/i/software/toolbox/faqjdbc.html#faqB5</a>
			</p></div><div class="section" id="db2-connection-closed"><div class="titlepage"><div><div><h4 class="title">29.4.2.&nbsp;"Connection closed" errors</h4></div></div></div><p>
			...
			</p></div><div class="section" id="db2-display-xml"><div class="titlepage"><div><div><h4 class="title">29.4.3.&nbsp;XML columns are not displayed properly in the DbExplorer</h4></div></div></div><p>
        ...
        refer to the chapter <a class="link" href="dbexplorer.html#customize-dbexplorer-retrieval" title="26.6.&nbsp;Customize data retrieval">Customize data retrieval in the DbExplorer</a>.
      </p><p>
      ...
      </p></div><div class="section" id="db2-error-text"><div class="titlepage"><div><div><h4 class="title">29.4.4.&nbsp;No error text is displayed</h4></div></div></div><p>
      ...
      </p></div><div class="section" id="db2-column-headers"><div class="titlepage"><div><div><h4 class="title">29.4.5.&nbsp;Displaying column headers instead of column names in result sets.</h4></div></div></div><p>
      ...
      </p></div><div class="section" id="db2-comments"><div class="titlepage"><div><div><h4 class="title">29.4.6.&nbsp;Column or table comments are not displayed</h4></div></div></div><a name="N16049" class="indexterm"></a><a name="N1604F" class="indexterm"></a><p>
        ...
        properties to <code class="literal">true</code> (e.g. using <a class="link" href="wb-commands.html#command-setconfig" title="24.45.&nbsp;Change an internal configuration parameter - WbSetConfig">WbSetConfig</a>)
      </p><p>
      ...
      </p></div><div class="section" id="db2-run-command"><div class="titlepage"><div><div><h4 class="title">29.4.7.&nbsp;DB2 commands like REORG cannot be run</h4></div></div></div><p>
      ...
      </p><pre class="programlisting">call sysproc.admin_cmd('REORG TABLE my_table');</pre></div></div><div class="section" id="pg-problems"><div class="titlepage"><div><div><h3 class="title">29.5.&nbsp;PostgreSQL</h3></div></div></div><a name="N1607F" class="indexterm"></a><a name="N16085" class="indexterm"></a><div class="section" id="pg-result-buffer"><div class="titlepage"><div><div><h4 class="title">29.5.1.&nbsp;WbExport or WbCopy using a lot of memory</h4></div></div></div><a name="N1608F" class="indexterm"></a><a name="N16095" class="indexterm"></a><p>
        ...
        More details can be found in the driver's manual:  <a class="ulink" href="http://jdbc.postgresql.org/documentation/83/query.html#query-with-cursor" target="_blank">http://jdbc.postgresql.org/documentation/83/query.html#query-with-cursor</a>
      </p></div></div><div class="section" id="sqlanywhere-problems"><div class="titlepage"><div><div><h3 class="title">29.6.&nbsp;Sybase SQL Anywhere</h3></div></div></div><a name="N160B0" class="indexterm"></a><div class="section" id="sqa-nchar"><div class="titlepage"><div><div><h4 class="title">29.6.1.&nbsp;Columns with type <code class="literal">nvarchar</code> are not displayed properly</h4></div></div></div><p>
      ...
      </p></div></div></div><div class="navfooter"><hr><table summary="Navigation footer" width="100%"><tr><td align="left" width="40%"><a accesskey="p" href="troubleshooting.html">Prev</a>&nbsp;</td><td align="center" width="20%">&nbsp;</td><td align="right" width="40%">&nbsp;<a accesskey="n" href="options.html">Next</a></td></tr><tr><td valign="top" align="left" width="40%">28.&nbsp;Common problems&nbsp;</td><td align="center" width="20%"><a accesskey="h" href="workbench-manual.html">Home</a></td><td valign="top" align="right" width="40%">&nbsp;30.&nbsp;Options dialog</td></tr></table></div></body></html>