<html><head><META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><title>16.&nbsp;DBMS specific features</title><link href="html-publish.css" type="text/css" rel="stylesheet"><meta content="DocBook XSL Stylesheets V1.79.0" name="generator"><link rel="home" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="up" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="prev" href="using-fk.html" title="15.&nbsp;Working with foreign keys"><link rel="next" href="using-variables.html" title="17.&nbsp;Variable substitution in SQL statements"><link rel="article" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="subsection" href="dbms-specific.html#dbms-specific-postgres" title="16.1.&nbsp;PostgreSQL specific features"><link rel="subsection" href="dbms-specific.html#dbms-specific-oracle" title="16.2.&nbsp;Oracle specific features"></head><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table summary="Navigation header" width="100%"><tr><th align="center" colspan="3">16.&nbsp;DBMS specific features</th></tr><tr><td align="left" width="20%"><a accesskey="p" href="using-fk.html">Prev</a>&nbsp;</td><th align="center" width="60%">&nbsp;</th><td align="right" width="20%">&nbsp;<a accesskey="n" href="using-variables.html">Next</a></td></tr></table><hr></div><div class="section" id="dbms-specific"><div class="titlepage"><div><div><h2 class="title" style="clear: both">16.&nbsp;DBMS specific features</h2></div></div></div><div class="toc"><dl class="toc"><dt><span class="section"><a href="dbms-specific.html#dbms-specific-postgres">16.1. PostgreSQL specific features</a></span></dt><dt><span class="section"><a href="dbms-specific.html#dbms-specific-oracle">16.2. Oracle specific features</a></span></dt></dl></div><div class="section" id="dbms-specific-postgres"><div class="titlepage"><div><div><h3 class="title">16.1.&nbsp;PostgreSQL specific features</h3></div></div></div><div class="section" id="postgres-open-trans"><div class="titlepage"><div><div><h4 class="title">16.1.1.&nbsp;Checking for un-committed changes</h4></div></div></div><a name="N11AA9" class="indexterm"></a><p>
       ...
       </p></div><div class="section" id="postgres-copy-api"><div class="titlepage"><div><div><h4 class="title">16.1.2.&nbsp;Using the COPY API for client side files</h4></div></div></div><a name="N11AC9" class="indexterm"></a><p>
       ...
       </p></div><div class="section" id="postgres-pgpass"><div class="titlepage"><div><div><h4 class="title">16.1.3.&nbsp;Using .pgpass</h4></div></div></div><a name="N11AED" class="indexterm"></a><a name="N11AF3" class="indexterm"></a><p>
...
workbench.db.postgresql.sql.usesavepoint=true
				...
				in the file <a class="link" href="settings.html" title="32.&nbsp;Advanced configuration options">workbench.settings</a>. If this is enabled,
        ...
        SQL Workbench/J can be configured to do the second approach automatically, by <a class="link" href="wb-commands.html#command-setconfig" title="24.45.&nbsp;Change an internal configuration parameter - WbSetConfig">setting the configuration property</a>
        ...
        by running an DML or DDL statement, nothing will be sent automatically.
         ...
         The checking for un-committed changes can be controlled through the <a class="link" href="profiles.html#profile-open-trans" title="7.6.13.&nbsp;Check for uncommitted changes">connection profile</a>.
       </p></div><div class="section" id="oracle-autotrace"><div class="titlepage"><div><div><h4 class="title">16.2.2.&nbsp;SQL*Plus autotrace mode</h4></div></div></div><a name="N11BF4" class="indexterm"></a><p>
         ...
         For details see the description of the <a class="link" href="wb-commands.html#command-set-autotrace" title="24.18.2.&nbsp;AUTOTRACE">SET</a> command.
       </p><p>
       ...
       </p></div><div class="section" id="oracle-source-dbms-metadata"><div class="titlepage"><div><div><h4 class="title">16.2.4.&nbsp;Using DBMS_METADATA for source retrieval</h4></div></div></div><a name="N11D13" class="indexterm"></a><p>
