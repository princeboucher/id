...
another_variable=24</pre><p>After executing
    ...
    </p><pre class="programlisting">SELECT * FROM person where name='Dent' or id=42;</pre></div><div class="section" id="vardef-select"><div class="titlepage"><div><div><h3 class="title">17.2.&nbsp;Populate a variable from a SELECT statement</h3></div></div></div><p>
      ...
      statement:
    </p><pre class="programlisting">WbVarDef id,name=@"SELECT id,firstname FROM person WHERE lastname='Dent'"</pre><p>
    ...
    </p></div><div class="section" id="vardef-read-content"><div class="titlepage"><div><div><h3 class="title">17.3.&nbsp;Populate a variable from a file</h3></div></div></div><p>
...
$[my_select];</pre><p>
    ...
    </p></div><div class="section" id="edit-variable"><div class="titlepage"><div><div><h3 class="title">17.4.&nbsp;Editing variables</h3></div></div></div><p>
      ...
      creating a new one.
    </p></div><div class="section" id="access-variable"><div class="titlepage"><div><div><h3 class="title">17.5.&nbsp;Using variables in SQL statements</h3></div></div></div><p>
      ...
      or you put the quotes around the variable's placeholder, e.g.: <code class="literal">WHERE name='$[name]';</code>
        ...
        Variables will be replaced in string literals (e.g. <code class="literal">'$[foo]'</code>)
...
workbench.sql.parameter.suffix=#</pre><p>
    ...
    </p></div><div class="section" id="prompt-variable"><div class="titlepage"><div><div><h3 class="title">17.6.&nbsp;Prompting for values during execution</h3></div></div></div><p>
      ...
      e.g. using <a class="link" href="wb-commands.html#command-setconfig" title="24.45.&nbsp;Change an internal configuration parameter - WbSetConfig">WbSetConfig</a>
