<html><head><META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><title>25.&nbsp;DataPumper</title><link href="html-publish.css" type="text/css" rel="stylesheet"><meta content="DocBook XSL Stylesheets V1.79.0" name="generator"><link rel="home" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="up" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="prev" href="wb-commands.html" title="24.&nbsp;Other SQL Workbench/J specific commands"><link rel="next" href="dbexplorer.html" title="26.&nbsp;Database Object Explorer"><link rel="article" href="workbench-manual.html" title="SQL Workbench/J User's Manual"><link rel="subsection" href="data-pumper.html#data-pumper-overview" title="25.1.&nbsp;Overview"><link rel="subsection" href="data-pumper.html#data-pumper-connecting" title="25.2.&nbsp;Selecting source and target connection"><link rel="subsection" href="data-pumper.html#data-pumper-simple-task" title="25.3.&nbsp;Copying a complete table"><link rel="subsection" href="data-pumper.html#data-pumper-advanced-tasks" title="25.4.&nbsp;Advanced copy tasks"></head><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table summary="Navigation header" width="100%"><tr><th align="center" colspan="3">25.&nbsp;DataPumper</th></tr><tr><td align="left" width="20%"><a accesskey="p" href="wb-commands.html">Prev</a>&nbsp;</td><th align="center" width="60%">&nbsp;</th><td align="right" width="20%">&nbsp;<a accesskey="n" href="dbexplorer.html">Next</a></td></tr></table><hr></div><div class="section" id="data-pumper"><div class="titlepage"><div><div><h2 class="title" style="clear: both">25.&nbsp;DataPumper</h2></div></div></div><div class="toc"><dl class="toc"><dt><span class="section"><a href="data-pumper.html#data-pumper-overview">25.1. Overview</a></span></dt><dt><span class="section"><a href="data-pumper.html#data-pumper-connecting">25.2. Selecting source and target connection</a></span></dt><dt><span class="section"><a href="data-pumper.html#data-pumper-simple-task">25.3. Copying a complete table</a></span></dt><dt><span class="section"><a href="data-pumper.html#data-pumper-advanced-tasks">25.4. Advanced copy tasks</a></span></dt></dl></div><div class="section" id="data-pumper-overview"><div class="titlepage"><div><div><h3 class="title">25.1.&nbsp;Overview</h3></div></div></div><p>The export and import features are useful if you cannot connect to
		...
		</p></div><div class="section" id="data-pumper-connecting"><div class="titlepage"><div><div><h3 class="title">25.2.&nbsp;Selecting source and target connection</h3></div></div></div><p>The DataPumper window is divided in three parts: the upper left part for
		...
		<a class="link" href="data-pumper.html#data-pumper-advanced-tasks" title="25.4.&nbsp;Advanced copy tasks">advanced tasks</a> section.</p><p>After source and target connection are established you can specify the tables and
		define the column mapping between the tables.</p></div><div class="section" id="data-pumper-simple-task"><div class="titlepage"><div><div><h3 class="title">25.3.&nbsp;Copying a complete table</h3></div></div></div><p>To copy a single table select the source and target table in the dropdowns (which
		...
		represents the column mapping between source and target table.</p><div class="section" id="column-mapping"><div class="titlepage"><div><div><h4 class="title">25.3.1.&nbsp;Mapping source to target columns</h4></div></div></div><p>Each row in the display maps a source column to a target column. Initially the DataPumper
			...
			</p></div><div class="section" id="source-where"><div class="titlepage"><div><div><h4 class="title">25.3.2.&nbsp;Restricting the data to be copied</h4></div></div></div><p>You can restrict the number of rows to be copied by specifying a
				...
				of the window.
			</p></div><div class="section" id="delete-target"><div class="titlepage"><div><div><h4 class="title">25.3.3.&nbsp;Deleting all rows from the target table</h4></div></div></div><p>When you select the option "Delete target table", all rows from
			...
			</p></div><div class="section" id="continue-error"><div class="titlepage"><div><div><h4 class="title">25.3.4.&nbsp;Continuing when an insert fails</h4></div></div></div><p>In some cases inserting of individual rows in the target table might
				...
				to insert
			</p></div><div class="section" id="commit-every"><div class="titlepage"><div><div><h4 class="title">25.3.5.&nbsp;Committing changes</h4></div></div></div><p>By default all changes are committed at the end, when all rows
			...
			row 50, row 100, row 150 and after the last row.</p></div><div class="section" id="data-pumper-batchupdate"><div class="titlepage"><div><div><h4 class="title">25.3.6.&nbsp;Batch execution</h4></div></div></div><p>If the JDBC driver supports batch updates, you can enable the use of batch updates with
			...
			</p></div></div><div class="section" id="data-pumper-advanced-tasks"><div class="titlepage"><div><div><h3 class="title">25.4.&nbsp;Advanced copy tasks</h3></div></div></div><div class="section" id="dp-constants"><div class="titlepage"><div><div><h4 class="title">25.4.1.&nbsp;Populating a column with a constant</h4></div></div></div><p>To populate a target column with a constant value. The name
			...
			selected, the field cannot be edited.</p></div><div class="section" id="create-target-table"><div class="titlepage"><div><div><h4 class="title">25.4.2.&nbsp;Creating the target table</h4></div></div></div><p>You can create the target table "on the fly" by selecting
        ...
        refer to <a class="link" href="settings.html#db-custom-type-map" title="Customizing data type mapping">Customizing data type mapping</a>
      </p></div><div class="section" id="source-query"><div class="titlepage"><div><div><h4 class="title">25.4.3.&nbsp;Using a query as the source</h4></div></div></div><p>If you want to copy the data from several tables into one
			...
			query as the source of the data</p></div></div></div><div class="navfooter"><hr><table summary="Navigation footer" width="100%"><tr><td align="left" width="40%"><a accesskey="p" href="wb-commands.html">Prev</a>&nbsp;</td><td align="center" width="20%">&nbsp;</td><td align="right" width="40%">&nbsp;<a accesskey="n" href="dbexplorer.html">Next</a></td></tr><tr><td valign="top" align="left" width="40%">24.&nbsp;Other SQL Workbench/J specific commands&nbsp;</td><td align="center" width="20%"><a accesskey="h" href="workbench-manual.html">Home</a></td><td valign="top" align="right" width="40%">&nbsp;26.&nbsp;Database Object Explorer</td></tr></table></div></body></html>