...
&lt;/java&gt;</pre><p>
		...
		to be passed on the command line.
	</p><div class="section" id="scripting-connecting"><div class="titlepage"><div><div><h3 class="title">18.1.&nbsp;Specifying the connection</h3></div></div></div><a name="N11F44" class="indexterm"></a><p>
		...
		</p></div><div class="section" id="scripting-scriptfile"><div class="titlepage"><div><div><h3 class="title">18.2.&nbsp;Specifying the script file(s)</h3></div></div></div><a name="N11F58" class="indexterm"></a><p>
			...
			You can also execute several scripts by using the <a class="link" href="wb-commands.html#command-wbinclude" title="24.10.&nbsp;Execute a SQL script - WbInclude (@)"><code class="literal">WbInclude</code></a>
...
SQLCMD</pre></div><div class="section" id="scripting-delimiter"><div class="titlepage"><div><div><h3 class="title">18.4.&nbsp;Specifying a delimiter</h3></div></div></div><p>
      ...
      through the profile or through the <code class="literal">-altDelimiter</code>
			...
			you have to create one "master" file, which calls the individual files using the <a class="link" href="wb-commands.html#command-wbinclude" title="24.10.&nbsp;Execute a SQL script - WbInclude (@)">WbInclude</a>
      ...
      If the filename is specified as a relative file, it is assumed to be in the current working directory.
			...
			<a class="link" href="wb-commands.html#command-connect" title="24.35.&nbsp;Change the connection for a script - WbConnect"><code class="literal">WbConnect</code></a>.
			...
			output (stdout, System.out) and can be redirected if desired.
				...
				of each statement. Inside a SQL script the <a class="link" href="wb-commands.html#command-wbfeedback" title="24.16.&nbsp;Control feedback messages - WbFeedback">WbFeedback</a> command
			...
			</p></div><div class="section" id="cmdline-parameter-progress"><div class="titlepage"><div><div><h4 class="title">18.12.3.&nbsp;Controlling statement progress information</h4></div></div></div><p>
		...
		</p></div><div class="section" id="script-vardef"><div class="titlepage"><div><div><h3 class="title">18.14.&nbsp;Defining variables</h3></div></div></div><a name="N120C4" class="indexterm"></a><a name="N120CA" class="indexterm"></a><p>
      ...
      </p></div><div class="section" id="script-properties"><div class="titlepage"><div><div><h3 class="title">18.15.&nbsp;Setting configuration properties</h3></div></div></div><a name="N120EA" class="indexterm"></a><p>
